...
# Primary database
SQLALCHEMY_DATABASE_URI = "postgresql://listenbrainz:listenbrainz@localhost:5432/listenbrainz"
MESSYBRAINZ_SQLALCHEMY_DATABASE_URI = "postgresql://messybrainz:messybrainz@localhost:5432/messybrainz"

POSTGRES_ADMIN_URI="postgresql://postgres@localhost/template1"
